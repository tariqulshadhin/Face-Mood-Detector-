...
public class Calm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference_happy=FirebaseDatabase.getInstance().getReference().child("Calm");
    ...
    public void goSongActivity(View view) {
        startActivity(new Intent(Calm.this,Songs.class));
    }

    public void gomain22activity(View view) {
        startActivity(new Intent(Calm.this,Main2Activity.class));
        finish();
    }
    @Override
