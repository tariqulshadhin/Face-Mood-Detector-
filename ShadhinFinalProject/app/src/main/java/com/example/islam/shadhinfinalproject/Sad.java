...
public class Sad extends AppCompatActivity {
    ...
    DatabaseReference reference,reference_motivational;
    ...
    private boolean initialStage4 = true;
     ...
     DatabaseReference reference_sad;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_paly_pause=findViewById(R.id.btn_play_pause);
        reference_motivational=FirebaseDatabase.getInstance().getReference().child("Motivational Speach");
        reference_sad=FirebaseDatabase.getInstance().getReference().child("Sad");


        reference_sad.child("01").addValueEventListener(new ValueEventListener() {
            @Override
        ...
        reference_sad.child("02").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                try {
                   String name=dataSnapshot.child("name").getValue().toString();
        ...
        reference_sad.child("03").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                try {
                   String name=dataSnapshot.child("name").getValue().toString();
        ...
        reference_sad.child("04").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                try {
                   String name=dataSnapshot.child("name").getValue().toString();
        ...
        reference_motivational.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                songname=dataSnapshot.child("song").getValue().toString();
        ...
        btn_paly_pause.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View view) {
                if (!playPause){
                    btn_paly_pause.setImageResource(R.drawable.pause);
                    if (initialStage){
                        new Player().execute(songname);
                    ...
                    btn_paly_pause.setImageResource(R.drawable.play);
    ...
    public class Player extends AsyncTask<String,Void,Boolean> {
        ...
        protected void onPostExecute(Boolean aBoolean) {
            ...
            if (progressDialog.isShowing()) {
                ...
                textView_timer.setText(String.format("%d min, %d sec",
    ...
    public void gosong(View view) {
        startActivity(new Intent(Sad.this,Songs.class));
    ...
    public void backtomain2activity(View view) {
        startActivity(new Intent(Sad.this,Main2Activity.class));
        finish();
    }
}
