...
public class Angree extends AppCompatActivity {
    ImageView imageView;
    ...
    DatabaseReference reference_angry;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_angree);
        ...
        reference_angry= FirebaseDatabase.getInstance().getReference().child("Angree");

        reference_angry.child("01").addValueEventListener(new ValueEventListener() {
            @Override
        ...
        reference_angry.child("02").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                try {
                    String name=dataSnapshot.child("name").getValue().toString();
        ...
        reference_angry.child("03").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                try {
                    String name=dataSnapshot.child("name").getValue().toString();
        ...
        reference_angry.child("04").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                try {
                    String name=dataSnapshot.child("name").getValue().toString();
    ...
    public void gosong(View view) {
        startActivity(new Intent(Angree.this,Songs.class));
        finish();
    }
